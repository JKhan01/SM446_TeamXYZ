...
def SendMail(emailMsg, receiver, subject):
    # Body of the email
    ...
    #input(print("Enter the subject of the email : "))
...
def SendMailWithAttachments(emailMsg, receiver, subject, file_dir, filename):
    # Body of the email
    #emailMsg = input(print("Enter the body of the email :"))
